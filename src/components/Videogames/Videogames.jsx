...
const Videogames = ({games}) => {
        ...
        return (  
                ...
                {currentGames[0] === 'Not Found'? <Error><h1>--404--</h1><h1>NO GAMES FOUND</h1></Error> :
                <Wrapper>      
                        {currentGames?.map((vg) => 
                                <VideogameCard
                                name={vg.name}
                ...
                <div>
                        <Pagination gamesPerPage={gamesPerPage} current={currentPage} totalGames={games.length} paginate={paginate}/>
                 </div>   
                </Container>
